...
BaseListItem {
    ...
    property color expandedColor: Theme.primaryColor
    ...
    RowLayout {
        ...
        Item {
            ...
            Icon {
                ...
                visible: name != ""
                color: listItem.expanded ? expandedColor : Theme.light.iconColor
                size: Units. dp(24)
            }
        }
        ...
        Label {
            ...
            color: listItem.expanded ? expandedColor : Theme.light.textColor
        }
