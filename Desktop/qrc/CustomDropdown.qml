...
PopupBase {
    ...
    property bool closeOnOtherDropDownOpen: true

    property var parentOverlay: null
    ...
    function open(caller, offsetX, offsetY) {
        ...
        parentOverlay = parent.currentOverlay
        if (parent.currentOverlay && parent.currentOverlay.closeOnOtherDropDownOpen)
        {
        ...
        } else if (__internal.centerLeftRight) {
        ...
        } else if (__internal.centerTopBottom) {
    ...
    function close() {
        ...
        if (parent.hasOwnProperty("currentOverlay")) {
            parent.currentOverlay = parentOverlay
        }
    ...
    QtObject {
        ...
        dropdown.anchor == Item.BottomLeft ||
        dropdown.anchor == Item.BottomRight
        property bool centerLeftRight: dropdown.anchor == Item.Center || dropdown.anchor == Item.Left || dropdown.anchor == Item.Right
        property bool centerTopBottom: dropdown.anchor == Item.Center || dropdown.anchor == Item.Top || dropdown.anchor == Item.Bottom
    }
    ...
    View {
        ...
        anchors.horizontalCenter: __internal.centerLeftRight ? parent.horizontalCenter : undefined
        anchors.verticalCenter: __internal.centerTopBottom ? parent.verticalCenter : undefined
    }
