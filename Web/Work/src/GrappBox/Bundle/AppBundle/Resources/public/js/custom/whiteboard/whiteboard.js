...
*
*/
app.controller('whiteboardController', ['$scope', '$http', '$routeParams', 'whiteboardFactory', function($scope, $http, $routeParams, whiteboardFactory) {
  ...
  $scope.initializeWhiteboardControls = function() {
    ...
    whiteboardFactory.setCanvasContext(canvasContext);
    ...
    canvas.onmouseup = function() {
      ...
      isMousePressed = false;
      canvasData = createRenderObject();
      whiteboardFactory.addToCanvasBuffer(canvasData);
  ...
  $scope.undoLastCanvasAction = function() {
    whiteboardFactory.undoLastCanvasAction();
    whiteboardFactory.renderAll();
