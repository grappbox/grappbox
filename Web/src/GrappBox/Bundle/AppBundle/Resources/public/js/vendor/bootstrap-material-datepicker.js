$.fn.datepicker = function(options) {
  var pickerHtml =
    [
      ...
      '<p class="year" data-bind="text: year"></p>',
      '<p class="date" data-bind="text: shortDay"></p>',
      '<p class="separator">, </p>',
      '<p class="month" data-bind="text: shortMonth"></p>',
      '<p class="separator"> </p>',
      '<p class="month" data-bind="text: dayNumber"></p>',
      '</section>',
      '<section class="calendar no-select">',
      '<a data-bind="click: prevMonth" class="control prev"><i class="material-icons">keyboard_arrow_left</i></a>',
      '<a data-bind="click: nextMonth" class="control next"><i class="material-icons">keyboard_arrow_right</i></a>',
  ...
  function AppViewModel(field, picker, options) {
    ...
    self.dayNumber = ko.computed(function() {
      return self.datePickerValue().format('DD');
    });
