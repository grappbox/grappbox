...
public class CloseBugTask extends AsyncTask<String, Void, String> {
    Context _context;
    APIConnectAdapter _api;
    OnTaskListener _listener;
    String _id = "";

    public CloseBugTask(Context context, OnTaskListener listener)
    {
        _context = context;
        _listener = listener;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            _api.startConnection("bugtracker/closeticket/" + token + "/" + _id);
