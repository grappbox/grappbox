 ...
 */
public class GetProjectUserTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            _api.startConnection("projects/getusertoproject/" + token + "/" + projectId);
        ...
        try {
            ...
            if (array != null)
            {
                for (int i = 0; i < array.length(); ++i) {
                    ...
                    cb.setText(current.getString("firstname") + " " + current.getString("lastname"));
