 ...
 */
public class EditCommentTask extends AsyncTask<String, Void, String> {
    Context _context;
    OnTaskListener _listener;
    APIConnectAdapter _api;

    public EditCommentTask(Context _context, OnTaskListener _listener) {
        this._context = _context;
        this._listener = _listener;
        this._api = APIConnectAdapter.getInstance(true);
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            data.put("commentId", params[0]);
            data.put("title", params[1]);
            data.put("description", params[2]);
            json.put("data", data);
            _api.startConnection("bugtracker/editcomment");
