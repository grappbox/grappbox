...
class WhiteboardController extends RolesAndTokenVerificationController
{
	...
	/**
	* @api {get} /V0.6.1/whiteboard/list/:token/:projectId Get the whiteboards' list of a project
	* @apiName listWhiteboard
	* @apiGroup Whiteboard
	* @apiVersion 0.6.2
	*
	...
	*/
	...
	/**
	* @api {post} /V0.6.1/whiteboard/new Create a new Whiteboard
	* @apiName createWhiteboard
	* @apiGroup Whiteboard
	* @apiVersion 0.6.2
	*
	...
	*/
	...
	/**
	* @api {get} /V0.6.1/whiteboard/open/:token/:id Open a whiteboard
	* @apiName openWhiteboard
	* @apiGroup Whiteboard
	* @apiVersion 0.6.2
	*
  ...
  *				"deletedAt": null
	...
	*/
	...
	/**
	* @api {put} V0.6.1/whiteboard/pushdraw/:id Push a whiteboard modification
	* @apiName pushDrawOnWhiteboard
	* @apiGroup Whiteboard
	* @apiVersion 0.6.1
	*
  ...
  *		"deletedAt": null
	...
	*/
	...
	/**
	* @api {get} /V0.6.1/whiteboard/pulldraw/:id Pull a whiteboard modification
	* @apiName pullDrawOnWhiteboard
	* @apiGroup Whiteboard
	* @apiVersion 0.6.1
	*
