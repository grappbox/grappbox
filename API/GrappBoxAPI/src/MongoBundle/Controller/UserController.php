...
class UserController extends RolesAndTokenVerificationController
{
	...
	*/
	public function getUserBasicInformationsAction(Request $request, $token, $userId)
	{
		...
		$userInfos = $this->getDoctrine()->getManager()->getRepository('MongoBundle:User')->find($userId);
		if ($userInfos === null)
		{
	...
	*/
	public function getIdByNameAction(Request $request, $token, $firstname, $lastname)
	{
		...
		return new JsonResponse($this->getDoctrine()->getManager()->getRepository('MongoBundle:User')->findUserByName($firstname, $lastname));
	}
	...
	*/
	public function getIdByEmailAction(Request $request, $token, $email)
	{
		...
		$userEmail = $this->getDoctrine()->getManager()->getRepository('MongoBundle:User')->findOneByEmail($email);
	...
	*/
	public function getNextMeetingsAction(Request $request, $token)
	{
		...
		return new JsonResponse($this->getDoctrine()->getManager()->getRepository('MongoBundle:Event')->findNextMeetings($user->getId()));
	}
	...
	*/
	public function getProjectsAction(Request $request, $token)
	{
		...
		return new JsonResponse($this->getDoctrine()->getManager()->getRepository('MongoBundle:Project')->findUserProjects($user->getId()));
	}
	...
	*/
	public function getAllTasksAction(Request $request, $token)
	{
		...
		return new JsonResponse($this->getDoctrine()->getManager()->getRepository('MongoBundle:Task')->findUserAllTasks($user->getId()));
	}
	...
	*/
	public function getCurrentAndNextTasksAction(Request $request, $token)
	{
		...
		return new JsonResponse($this->getDoctrine()->getManager()->getRepository('MongoBundle:Task')->findUserCurrentAndNextTasks($user->getId()));
	}
}
