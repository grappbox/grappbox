...
class DashboardController extends RolesAndTokenVerificationController
{
	...
	*/
	public function getTeamOccupationAction(Request $request, $token, $id)
	{
		...
		return $this->getDoctrine()->getManager()->getRepository('SQLBundle:Project')->findTeamOccupationV2($project->getId());
	}
  ...
  */
	public function getNextMeetingsAction(Request $request, $token, $id)
	{
		...
		return $this->getDoctrine()->getManager()->getRepository('SQLBundle:Event')->findNextMeetingsV2($user->getId(), $id, "2", "Dashboard", "getnextmeetings");
	}
	...
	*/
	public function getProjectsGlobalProgressAction(Request $request, $token)
	{
		...
		return ($this->getDoctrine()->getManager()->getRepository('SQLBundle:Project')->findProjectGlobalProgressV2($user->getId()));
	}
  ...
  *		}
	...
	*/
	public function getProjectCreatorAction(Request $request, $token, $id)
	{
		...
		$user = $em->getRepository('SQLBundle:User')->find($creatorId);
  ...
  *		}
	...
	*/
	public function getProjectTasksAction(Request $request, $token, $id)
	{
		...
		$em = $this->getDoctrine()->getManager();
		$tasks = $em->getRepository('SQLBundle:Task')->findByprojects($id);
  ...
  *		}
	...
	*/
	public function getNumberTimelineMessagesAction(Request $request, $token, $id)
	{
		...
		$em = $this->getDoctrine()->getManager();
		$timelineMessages = $em->getRepository('SQLBundle:TimelineMessage')->findBytimelineId($id);
	...
	*/
	public function getNumberBugsAction(Request $request, $token, $id)
	{
		...
		$em = $this->getDoctrine()->getManager();
		$bugs = $em->getRepository('SQLBundle:Bug')->findByprojectId($id);
