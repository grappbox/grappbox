...
class Timeline
{
     ...
     *
     * @param \SQLBundle\Entity\TimelineMessage $timelineMessages
     * @return Timeline
     */
    public function addTimelineMessage(\SQLBundle\Entity\TimelineMessage $timelineMessages)
    {
     ...
     * @param \SQLBundle\Entity\TimelineMessage $timelineMessages
     */
    public function removeTimelineMessage(\SQLBundle\Entity\TimelineMessage $timelineMessages)
    {
