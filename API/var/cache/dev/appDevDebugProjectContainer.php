...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'service_cloud' => 'getServiceCloudService',
            'service_container' => 'getServiceContainerService',
            'service_notifs' => 'getServiceNotifsService',
            'service_stat' => 'getServiceStatService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('GDloPMH3aV', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yETNdzRwhh', 0, 'AjagiOFbQZDa2phnBYTN2u', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Tc23C5pqVp', 0, 'AjagiOFbQZDa2phnBYTN2u', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oaRhkYJjdh', 0, 'AjagiOFbQZDa2phnBYTN2u', (__DIR__.'/pools'), $a));
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\SQLBundle\\Resources\\config\\doctrine') => 'SQLBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'SQLBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SQLBundle' => 'SQLBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5496af10c1dddc88515928c4242922c846f2ae88a8111e2ef6b45ee78d5c4ebe');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf2mongodb_default_5496af10c1dddc88515928c4242922c846f2ae88a8111e2ef6b45ee78d5c4ebe');

        $b = new \Doctrine\Bundle\MongoDBBundle\Mapping\Driver\YamlDriver(array(($this->targetDirs[3].'\\src\\MongoBundle\\Resources\\config\\doctrine') => 'MongoBundle\\Document'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MongoBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('MongoBundle' => 'MongoBundle\\Document'));
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'))), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('SQLBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13)), 'MongoBundle\\Document\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    /**
     * Gets the 'service_cloud' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SQLBundle\Controller\CloudController A SQLBundle\Controller\CloudController instance
     */
    protected function getServiceCloudService()
    {
        $this->services['service_cloud'] = $instance = new \SQLBundle\Controller\CloudController();
    ...
    /**
     * Gets the 'service_notifs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SQLBundle\Controller\NotificationController A SQLBundle\Controller\NotificationController instance
     */
    protected function getServiceNotifsService()
    {
        $this->services['service_notifs'] = $instance = new \SQLBundle\Controller\NotificationController();
    ...
    /**
     * Gets the 'service_stat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SQLBundle\Controller\StatisticController A SQLBundle\Controller\StatisticController instance
     */
    protected function getServiceStatService()
    {
        $this->services['service_stat'] = $instance = new \SQLBundle\Controller\StatisticController();
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SQLBundle/Resources/views'), 'SQL');
        $instance->addPath(($this->targetDirs[3].'\\src\\MongoBundle/Resources/views'), 'Mongo');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SQLBundle' => 'SQLBundle\\SQLBundle',
                'MongoBundle' => 'MongoBundle\\MongoBundle',
            ...
            'database_port_dev' => NULL,
            'database_name_dev' => 'symfony',
            'database_user_dev' => 'root',
            'database_password_dev' => NULL,
            'locale' => 'en',
