...
namespace GrappBox.View
{
    ...
    public sealed partial class WhiteBoardView : Page
    {
        ...
        private async void FillcolorBtn_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void drawingCanvas_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            ...
            else if (wbvm.CurrentTool == WhiteboardTool.TEXT)
            {
                ...
                try
                {
                    result = await wbt.WaitForSelect(cancelToken.Token);
                }
                catch (OperationCanceledException ex)
                {
                    return;
                ...
                if (result == true)
                {
                    ShapeControler sc = new ShapeControler(pos: e.GetPosition(drawingCanvas), txt: wbt.TextEntered,
                        bold: wbt.IsBold, italic: wbt.IsItalic, stroke: wbvm.StrokeColor, size: (int)wbt.FontSizeProp);
                    WhiteboardObject wo = await wbvm.pushDraw(ShapeModelConverter.ShapeToModel(sc));
                    drawingCanvas.AddNewElement(wo);
                }
            }
        }

        private void drawingCanvas_ManipulationStarted(object sender, Windows.UI.Xaml.Input.ManipulationStartedRoutedEventArgs e)
        {

        }

        private void drawingCanvas_ManipulationDelta(object sender, Windows.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs e)
        {

        }

        private void drawingCanvas_ManipulationCompleted(object sender, Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs e)
        {
